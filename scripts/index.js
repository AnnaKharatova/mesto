...
const inputName = document.querySelector('#popup-profile__name');
const profileProfession = document.querySelector('#profile__profession');
const inputProfession = document.querySelector('#popup-profile__profession');
...
const cardInputName = document.querySelector('#popup-card__place');
const cardInputLink = document.querySelector('#popup-card__url');
