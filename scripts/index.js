...
const inputName = document.querySelector('#popup__profile__name');
const profileProfession = document.querySelector('#profile__profession');
const inputProfession = document.querySelector('#popup__profile__profession');
...
const cardInputName = document.querySelector('#popup__card__place');
const cardInputLink = document.querySelector('#popup__card__url');
